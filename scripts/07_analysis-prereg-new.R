...
dat <- dat |>
  mutate(Batch = case_when(
    str_starts(StartDate, "10/16/2024") ~ 1,
    str_starts(StartDate, "10/24/2024") ~ 2,
    str_starts(StartDate, "10/30/2024") ~ 3
  ))
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             output = "results/01_preregistered-new.png")
...
modelsummary(list("Trust H1" = m_trust_h1_s,
             ...
             coef_omit = "Intercept",
             notes = list('p-values: * < 0.05 ** < 0.01 *** < 0.001'),
             output = "results/01_preregistered-new.docx")
